define('stampino-demo', ['stampino'], (stampino) => {
  'use strict';
  ...
  function runDemo(id, model) {
    ...
    stampino.render(template, output, model, {
      ...
      renderers: {
        'source': function(model, renderers, handlers, attributeHandler) {
          stampino.renderNode(source, model, renderers, handlers, attributeHandler);
        },
        'demo': function(model, renderers, handlers, attributeHandler) {
          demoRenderer(model);
        },
      },
    });
